...
Our models achieve the state-of-the-art performance on above all datasets (eg. 77.64 % on ImageNet, 96.04 % on CIFAR10, 80.75 % on CIFAR10, 81.4% on CIFAR10-DVS) in directly trained SNNs in 2023/05.
